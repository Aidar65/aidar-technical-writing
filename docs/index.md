...
!!! note "NDA & Sandbox Disclaimer"
    ...
    Основная рабочая документация ведятся в закрытых корпоративных контурах под NDA. Представленные кейсы обезличены и адаптированы для демонстрации IT-стека.

---

## 👤 Профиль и ключевые метрики

**Technical Content Engineer / Technical Writer** с опытом стандартизации и документирования сложных программно-аппаратных комплексов (АСУ ТП, ТПА, ИСУЭ).
